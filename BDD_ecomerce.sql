...
ALTER TABLE `cart` DROP FOREIGN KEY `fk_product_id_2`, DROP FOREIGN KEY `fk_user_id_3`;
ALTER TABLE `code` DROP FOREIGN KEY `fk_user_id_2`;
ALTER TABLE `order_history` DROP FOREIGN KEY `fk_cart_id_1`;
ALTER TABLE `payment` DROP FOREIGN KEY `fk_user_id_4`;
ALTER TABLE `rating` DROP FOREIGN KEY `fk_user_id_6`, DROP FOREIGN KEY `fk_product_id_1`;
ALTER TABLE `wishlist` DROP FOREIGN KEY `fk_product_id_5`, DROP FOREIGN KEY `fk_user_id_5`;
...
(9, 1, 'root', 'root', 'root@gmail.com', 0, 'https://images.hdqwalls.com/download/rick-and-morty-in-another-dimension-illustration-6c-3840x2400.jpg', '$2y$10$TbyXM2/A2BisIl6UUHOFfOyi/cg4AYjN3IgKmGZVPPG1jWlmhwmP.', NULL, '0605297821', 'france', '26 rue etienne marcel', '77450', 'montry', 0, NULL);

            ...
            <div class="profile">
				...
				<?php
					...
					if ($result->num_rows > 0) {
    					...
    					echo '<div>';
						echo '<form method="post" action="Modifiuser.php">';
    					echo '<input type="text" id="fname" name="fname" placeholder="Nouvelle information">';
    					echo '</div>';
						echo '<br>';
    					echo '<div>';
    					echo '<select name="info" id="infos">';
    					echo '<option value="Last_name">Nom</option>';
    					echo '<option value="First_name">Prenom</option>';
    					echo '<option value="City">Ville</option>';
    					echo '<option value="Adress">Adresse</option>';
   						echo '<option value="Postal_code">Code postal</option>';
    					echo '<option value="Phone">Téléphone</option>';
    					echo '</select>';
						echo '<br>';
						echo '<br>';    
    					echo '</div>';
    					echo '<div>';
    					echo '<button type="submit" onclick="modifiuser.php">Modifier</button>';
    					echo '</div>';
   						echo '</form>';
						echo '</div>';
